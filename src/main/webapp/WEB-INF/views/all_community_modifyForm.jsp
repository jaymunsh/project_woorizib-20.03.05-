...
<div id="body_layout">
	<div class="body_wrap">
        ...
        <div class="contents_wrap">
			<form action="all_community_modifyPro.all?" method="post" name="modifyPro" id="form">
			<input type="hidden" name = "${_csrf.parameterName}" value = "${_csrf.token}">	
			<input type="hidden" name="gnd_number" value="${gnd_number}">
			...
			<table class="tbl_type1 type5">
				...
				<tbody>
					...
					<tr>
						<th scope="row">제목</th>
						<td>
							<input type="text" class="inp_txt" title="제목 입력" name="gnd_title" id="counselTitle" 
							placeholder="50자 이내로 적어주세요." style="width:532px;" maxlength="50" value="${dto.gnd_title}">
						</td>
					</tr>
					<tr>
						<th scope="row">내용</th>
						<td>
							<div class="inp_wrap type2">
								<textarea title="내용 입력" class="txtarea wrt_cont lengthLimit" name="gnd_content" id="counselContent" placeholder="내용을 입력해주세요." style="height:340px" maxlength="1000" required>
								${dto.gnd_content}</textarea>
							</div>
			...
			<div class="btn_wrap2">
				...
				<input type="button" onclick="load('all_community_List.all');" class="btn_type7" id="counselCancel" value="취소">
			</div>
			</form>
		</div>
        <!-- 컨텐츠 끝 -->
