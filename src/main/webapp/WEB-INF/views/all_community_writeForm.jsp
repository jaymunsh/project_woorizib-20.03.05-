	...
	<div class="body_wrap">
        ...
        <div class="contents_wrap">
			...
			<table class="tbl_type1 type5">
				...
				<tbody>
					<tr>
						<th scope="row">작성자<span class="fc_red"></th>
						<td>${sessionScope.memID}</td>
					</tr>
					<tr>
						<th scope="row">제목<span class="fc_red">*<span class="blind">필수입력</span></span></th>
						<td>
							<input type="text" class="inp_txt" title="제목 입력" name="gnd_title" id="counselTitle" placeholder="50자 이내로 적어주세요." style="width:532px;" maxlength="50" autofocus required>
						</td>
					</tr>
					<tr>
						...
						<td>
							<div class="inp_wrap type2">
								<textarea title="내용 입력" class="txtarea wrt_cont lengthLimit" name="gnd_content" id="counselContent" placeholder="내용을 입력해주세요." style="height:340px" maxlength="1000" required></textarea>
								<span class="char_cnt"><em class="fc_gray6 lengthLimitCounter">0</em>/1000자</span>
							</div>
							<p class="txt_tip"><span class="tag_comm type5">공지</span>무고, 비방, 욕설 등 목적에 부합하지 않은 게시글 임의 삭제 알림</p>
						</td>
					</tr>
				</tbody>
			</table>
			<div class="btn_wrap2">
				<input type="submit" class="btn_type6" id="counselSave" value="등록">
				<input type="button" value="취소" onclick="load('all_community_List.all?pageNum=${pageNum}');" class="btn_type7" id="counselCancel">
				<!-- <a onclick="window.history.back();" class="btn_type7" id="counselCancel">취소</a> -->
			</div>
			</form>
		</div>
        <!-- 컨텐츠 끝 -->
