							...
							<table>
								...
								<c:forEach var = "auction" items="${auctionList}">
									<tr>
										...
										<td><img style="width: 100px; height: 70px;" src="${sellerpage}/images/${auction.prp_image}"></td>
										<td><a href="noticeDetail.all">${auction.auc_name}</a></td>
										<td>${auction.auc_opendate}</td>
										<td style="width: 200px;">
											<input style="width: 70px; heieght: 40px;" type="button" value="수정" onclick="auctionModify('${auction.auc_number}');">
											<input style="width: 70px; height: 40px;" type="button" value="삭제"  onclick="auctionDelete('${auction.auc_number}');">
										</td>
									</tr>
								</c:forEach>
								</tbody>
...
<!--
	박찬하 2020.03.05 
	auction Imformation modify and delete
-->
