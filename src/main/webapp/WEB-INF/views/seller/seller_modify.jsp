...
<div class="article">
        <form action = "seller_modifyPro.sel?${_csrf.parameterName}=${_csrf.token}" method = "post" enctype="multipart/form-data">
        <%-- <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"> --%>
            <table style="border-collapse: collapse" align = center>
            	...
            	<tr>
            		<th>매물명</th>
            		<td>
            			<input type="text" name="prp_name" placeholder="매물명" value="${vo.prp_name }">
            		</td>
            	</tr>
      ...
      <!--   <div style="border-bottom:1px solid black; width: 70%; height: 30px; margin-left:50px;">
            ...
            <tr>
            	<th>월세 보증금</th>
            	<td><input type="text" name="prp_deposit" placeholder="월세 보증금" value="${vo.prp_deposit }"></td>
            </tr>
            
            <tr>
            	<th>월세가격</th>
            	<td><input type="text" name="prp_monthlycost" placeholder="월세가격" value="${vo.prp_monthlycost }"></td>
            </tr>
            
            <tr>
            	<th>전세가격</th>
            	<td><input type="text" name="prp_leasecost" placeholder="전세가격" value="${vo.prp_leasecost }"></td>
            </tr>
            
            <tr>
            	<th>매매가격</th>
            	<td><input type="text" name="prp_propertycost" placeholder="매매가격" value="${vo.prp_propertycost }"></td>
            </tr>
            ...
            <tr>
            	<th>관리비</th>
            	<td>
            		<input type="text" name="prp_maintenancecost" value="${vo.prp_maintenancecost }">
            	</td>
            </tr>
            <tr>
                <th rowspan="2">
       ...
       <!--  <div style="border-bottom:1px solid black; width: 70%; height: 30px; margin-left:50px;">
        ...
        <br><br> -->
         	...
         	<tr>
         		<th>매물 추가 옵션</th>
         		<td><input type="text" name="prp_moreoption" placeholder="매물추가옵션" value="${vo.prp_moreoption }"></td>
         	</tr>
         	<tr>
         		<th>매물 엘리베이터 여부</th>
         		<td>
             ...
             <tr>
             	<th>상세설명</th>
             	<td>
             		<textarea rows="10" cols="60" name="prp_detail" value=${vo.prp_detail }></textarea>
             	</td>
